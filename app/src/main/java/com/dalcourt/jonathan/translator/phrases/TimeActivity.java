...
public class TimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word(getString(R.string.phrases_at_what_time),
                "¿A qué hora es el...?"));
        words.add(new Word(getString(R.string.phrases_time_is),
                "Es la uno, Son las..."));
        words.add(new Word(getString(R.string.phrases_what_time),
                "¿Qué hora es?"));
